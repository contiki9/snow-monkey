...
@media (min-width: 40em) {
  .c-flex-media:before, .c-flex-media:after {
    content: " ";
    display: table;
  }
  .c-flex-media:after {
...
.c-input-group__addon, .c-input-group__field, .c-input-group__btn {
  display: table-cell;
...
.c-row--reverse > .c-row__col {
  direction: ltr;
}

.c-row--nowrap > .c-row__col {
  display: table-cell;
}
...
.c-row--between > .c-row__col {
  display: inline-block;
}

.c-row--top > .c-row__col {
  display: inline-block;
  vertical-align: top;
}

.c-row--bottom > .c-row__col {
  display: inline-block;
  vertical-align: bottom;
}

.c-row--middle > .c-row__col {
  display: inline-block;
  vertical-align: middle;
}

.c-row--baseline > .c-row__col {
  display: inline-block;
  vertical-align: baseline;
}

.c-row--margin, .c-row--margin-s, .c-row--margin-l {
  display: block;
  width: auto;
}
...
@media (min-width: 40em) {
  .c-row--md-nowrap > .c-row__col {
    display: table-cell;
  }
  .c-row--md-left {
    text-align: left;
  }
  .c-row--md-left > .c-row__col {
    display: inline-block;
  }
  .c-row--md-right {
    text-align: right;
  }
  .c-row--md-right > .c-row__col {
    display: inline-block;
  }
  .c-row--md-center {
    text-align: center;
  }
  .c-row--md-center > .c-row__col {
    display: inline-block;
  }
  .c-row--md-between {
    display: block;
  ...
  .c-row--md-between:after {
    content: '';
    display: inline-block;
    width: 100%;
  }
  .c-row--md-between > .c-row__col {
    display: inline-block;
  }
  .c-row--md-top > .c-row__col {
    display: inline-block;
    vertical-align: top;
  }
  .c-row--md-bottom > .c-row__col {
    display: inline-block;
    vertical-align: bottom;
  }
  .c-row--md-middle > .c-row__col {
    display: inline-block;
    vertical-align: middle;
  }
  .c-row--md-baseline > .c-row__col {
    display: inline-block;
    vertical-align: baseline;
  }
  .c-row--md-margin, .c-row--md-margin-s, .c-row--md-margin-l {
    display: block;
    width: auto;
  }
...
@media (min-width: 64em) {
  .c-row--lg-nowrap > .c-row__col {
    display: table-cell;
  }
  .c-row--lg-left {
    text-align: left;
  }
  .c-row--lg-left > .c-row__col {
    display: inline-block;
  }
  .c-row--lg-right {
    text-align: right;
  }
  .c-row--lg-right > .c-row__col {
    display: inline-block;
  }
  .c-row--lg-center {
    text-align: center;
  }
  .c-row--lg-center > .c-row__col {
    display: inline-block;
  }
  .c-row--lg-between {
    display: block;
  ...
  .c-row--lg-between:after {
    content: '';
    display: inline-block;
    width: 100%;
  }
  .c-row--lg-between > .c-row__col {
    display: inline-block;
  }
  .c-row--lg-top > .c-row__col {
    display: inline-block;
    vertical-align: top;
  }
  .c-row--lg-bottom > .c-row__col {
    display: inline-block;
    vertical-align: bottom;
  }
  .c-row--lg-middle > .c-row__col {
    display: inline-block;
    vertical-align: middle;
  }
  .c-row--lg-baseline > .c-row__col {
    display: inline-block;
    vertical-align: baseline;
  }
  .c-row--lg-margin, .c-row--lg-margin-s, .c-row--lg-margin-l {
    display: block;
    width: auto;
  }
